...
const PostPage = () => {
  const [post, setPost] = useState<PostInterface>({
    postId: '2',
    title: 'Terra USD Price Analysis',
    author: '0xPlain',
    comments: [
  ...
  return (
    ...
    <div>
      <Header/>
      <h1 className="text-2xl font-bold text-center ml-4">{post.title}</h1>
      <h2 className="text-sm text-center ml-4 text-gray-600">By {post.author}</h2>
      <div>
        <div className="flex justify-center">
        <img src="/Static2.png" alt="Static Chart" />
        </div>
      </div>
